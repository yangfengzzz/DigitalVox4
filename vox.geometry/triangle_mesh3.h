...
public:
    ...
    using Vector2DArray = std::vector<Vector2D>;
    using Vector3DArray = std::vector<Vector3D>;
    using PointArray = std::vector<Point3D>;
    using IndexArray = std::vector<Point3UI>;
...
private:
    ...
    mutable std::vector<Vector3D> _wnAreaWeightedNormalSums;
    mutable std::vector<Point3D> _wnAreaWeightedAvgPositions;
