...
template<class T>
class IMATH_EXPORT_TEMPLATE_TYPE Color3 : public Vec3<T> {
public:
...
template<class T>
IMATH_HOSTDEVICE constexpr inline Color3<T>::Color3(T a) IMATH_NOEXCEPT : Vec3<T>(a) {
    // empty
}

template<class T>
IMATH_HOSTDEVICE constexpr inline Color3<T>::Color3(T a, T b, T c) IMATH_NOEXCEPT : Vec3<T>(a, b, c) {
    // empty
}

template<class T>
IMATH_HOSTDEVICE constexpr inline Color3<T>::Color3(const Color3 &c) IMATH_NOEXCEPT : Vec3<T>(c) {
    // empty
}
