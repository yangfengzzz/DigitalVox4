...
#include "cloth_mesh_generator.h"
#include <fstream>
...
void ClothMeshData::GeneratePlaneCloth(float width, float height, int segmentsX, int segmentsY,
                                       bool createQuads, physx::PxMat44 transform, bool alternatingDiagonals, int zigzag) {
    /*
