...
#ifndef cpp_mtl_ResourceEnum_hpp
#define cpp_mtl_ResourceEnum_hpp
...
typedef enum ResourceOptions {
    ...
    ResourceStorageModeShared     API_AVAILABLE(macos(10.11), ios(9.0)) =
    StorageModeShared << ResourceStorageModeShift,
    ResourceStorageModeManaged    API_AVAILABLE(macos(10.11), macCatalyst(13.0)) API_UNAVAILABLE(ios) =
    StorageModeManaged << ResourceStorageModeShift,
    ResourceStorageModePrivate    API_AVAILABLE(macos(10.11), ios(9.0)) =
    StorageModePrivate << ResourceStorageModeShift,
    ResourceStorageModeMemoryless API_AVAILABLE(ios(10.0)) API_UNAVAILABLE(macos, macCatalyst) =
    StorageModeMemoryless << ResourceStorageModeShift,
    
    ResourceHazardTrackingModeDefault API_AVAILABLE(macos(10.13), ios(10.0)) =
    HazardTrackingModeDefault << ResourceHazardTrackingModeShift,
    ResourceHazardTrackingModeUntracked API_AVAILABLE(macos(10.13), ios(10.0)) =
    HazardTrackingModeUntracked << ResourceHazardTrackingModeShift,
    ResourceHazardTrackingModeTracked API_AVAILABLE(macos(10.15), ios(13.0)) =
    HazardTrackingModeTracked << ResourceHazardTrackingModeShift,
} ResourceOptions;


} // namespace MTL

#endif // cpp_mtl_ResourceEnum_hpp
