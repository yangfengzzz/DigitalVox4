...
: m_objCObj([rhs.m_objCObj copyWithZone:nil]), m_texture(rhs.m_texture) {
    // Member initialization only
}
...
RenderPassDepthAttachmentDescriptor::RenderPassDepthAttachmentDescriptor()
: RenderPassAttachmentDescriptor([MTLRenderPassDepthAttachmentDescriptor new]), m_objCContainer(nil) {
}

RenderPassDepthAttachmentDescriptor::RenderPassDepthAttachmentDescriptor(const RenderPassDepthAttachmentDescriptor &rhs)
: RenderPassAttachmentDescriptor(rhs), m_objCContainer(nil) {
}
...
RenderPassStencilAttachmentDescriptor::RenderPassStencilAttachmentDescriptor()
: RenderPassAttachmentDescriptor([MTLRenderPassStencilAttachmentDescriptor new]), m_objCContainer(nil) {
    // Member initialization only
}
