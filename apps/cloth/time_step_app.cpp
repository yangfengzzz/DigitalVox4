...
void TimeStepApp::_initializeCloth(EntityPtr entity, int index, physx::PxVec3 offset) {
    ...
    _clothActor[index].cloth->setGravity(physx::PxVec3(0.0f, -9.8f*0.0f, 0.0f));
    _clothActor[index].cloth->setTetherConstraintStiffness(0.01);
    _clothActor[index].cloth->setStiffnessFrequency(10);
    _clothActor[index].cloth->setTetherConstraintScale(0.7);
    if(index == 0) {
        _clothActor[index].cloth->setSolverFrequency(60);
    } else {
        _clothActor[index].cloth->setSolverFrequency(300);
    }
...
void TimeStepApp::loadScene() {
    ...
    _initializeCloth(clothEntity, 0,physx::PxVec3(-7.0f, 2.0f, 0.0f));
    _initializeCloth(clothEntity, 1, physx::PxVec3(2.0f, 2.0f, 0.0f));
}
