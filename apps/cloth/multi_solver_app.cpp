...
void MultiSolverApp::_initializeCloth(EntityPtr entity, int index, physx::PxVec3 offset) {
    ...
    _clothActor[index].cloth->setDamping(physx::PxVec3(0.1f, 0.1f, 0.1f));
    _clothActor[index].cloth->setFriction(0.5f);
    ...
    _clothActor[index].cloth->setSpheres(nv::cloth::Range<physx::PxVec4>(spheres, spheres + 2), 0, _clothActor[index].cloth->getNumSpheres());

    uint32_t caps[4];
    caps[0] = 0;
    caps[1] = 1;
    _clothActor[index].cloth->setCapsules(nv::cloth::Range<uint32_t>(caps, caps + 2), 0, _clothActor[index].cloth->getNumCapsules());
    ...
    _clothActor[index].cloth->setDragCoefficient(0.5f);
    _clothActor[index].cloth->setLiftCoefficient(0.6f);
...
void MultiSolverApp::loadScene() {
    ...
    _initializeCloth(clothEntity, 0, physx::PxVec3(-5.0f, 0.0f, 0.0f));
    _initializeCloth(clothEntity, 1, physx::PxVec3(5.0f, 0.0f, 0.0f));
}
