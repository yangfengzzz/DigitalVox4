...
void StiffnessPerConstraintApp::_initializeCloth(EntityPtr entity, physx::PxVec3 offset) {
    ...
    clothMesh.GeneratePlaneCloth(5.f, 6.25f, 20, 20, false, transform);
    ...
    _clothActor.cloth->setTetherConstraintStiffness(0.1); // new term
    _clothActor.cloth->setTetherConstraintScale(1.5f);
    _clothActor.cloth->setDragCoefficient(0.1);
    _clothActor.cloth->setSolverFrequency(120.0f);
