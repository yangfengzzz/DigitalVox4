...
void SphereApp::_initializeCloth(EntityPtr entity, physx::PxVec3 offset) {
    ...
    _clothActor.cloth->setSpheres(nv::cloth::Range<physx::PxVec4>(spheres, spheres + 1), nv::cloth::Range<physx::PxVec4>(spheres, spheres + 1));
...
void SphereApp::loadScene(uint32_t width, uint32_t height) {
    ...
    renderer->setMesh(PrimitiveMesh::createSphere(_device.get(), 1.4));
    auto material = std::make_shared<BlinnPhongMaterial>();
