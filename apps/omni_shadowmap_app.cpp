...
void OminiShadowMapApp::loadScene(uint32_t width, uint32_t height) {
    ...
    auto planeMtl2 = std::make_shared<BlinnPhongMaterial>();
    ...
    auto planeMtl3 = std::make_shared<BlinnPhongMaterial>();
    ...
    auto planeMtl4 = std::make_shared<BlinnPhongMaterial>();
    ...
    auto planeMtl5 = std::make_shared<BlinnPhongMaterial>();
